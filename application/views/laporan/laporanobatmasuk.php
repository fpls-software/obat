        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/laporan/obatmasuk">Data Obat Masuk</a></li>
            ...
            <div class="card-body" id="printMe">
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <th>Nama Obat</th>
                        <th>Suplier</th>
                        <th width="200">Jumlah Obat Masuk</th>
                    ...
                    <tbody>
                        <?php 
                            $no = 1;
                            foreach($laporanobatmasuk as $data) { 
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            ...
                            <td><?php echo $data['jml_obat_masuk']; ?></td>
