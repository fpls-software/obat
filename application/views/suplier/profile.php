    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url(); ?>index.php/pengaturan/updateprofilesuplier" method="post">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="hidden" name="id_suplier" class="form-control" value="<?php echo $data['id_suplier']; ?>">
