        ...
        <div class="continer-fluid">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Transaksi Obat Keluar</h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url(); ?>index.php/transaksi/tambahobatkeluar" method="post">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jml_obat_keluar">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
